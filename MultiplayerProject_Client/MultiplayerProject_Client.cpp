	...
	while (window.isOpen())
	{
		...
		if (window.hasFocus())
		{
			if ((Keyboard::isKeyPressed(Keyboard::Left) || (Keyboard::isKeyPressed(Keyboard::A)))) {
				...
				player.sprite.setTextureRect(IntRect(42 * int(CurrentFrame)+42, 42*3, -42, 42)); //через объект p класса player меняем спрайт, делая анимацию (используя оператор точку)
			}
			...
			if ((Keyboard::isKeyPressed(Keyboard::Right) || (Keyboard::isKeyPressed(Keyboard::D)))) {
				...
				CurrentFrame += 0.1 * time;
				if (CurrentFrame > 8) CurrentFrame -= 8;
				player.sprite.setTextureRect(IntRect(42 * int(CurrentFrame), 42 * 3, 42, 42));  //через объект p класса player меняем спрайт, делая анимацию (используя оператор точку)
			}
			...
			if ((Keyboard::isKeyPressed(Keyboard::Up) || (Keyboard::isKeyPressed(Keyboard::W)))) {
				...
				CurrentFrame += 0.1 * time;
				if (CurrentFrame > 8) CurrentFrame -= 8;
				player.sprite.setTextureRect(IntRect(42 * int(CurrentFrame), 0, 42, 42));  //через объект p класса player меняем спрайт, делая анимацию (используя оператор точку)
			}
			...
			if ((Keyboard::isKeyPressed(Keyboard::Down) || (Keyboard::isKeyPressed(Keyboard::S)))) { //если нажата клавиша стрелка влево или англ буква А
				...
				CurrentFrame += 0.1 * time;
				if (CurrentFrame > 8) CurrentFrame -= 8;
				player.sprite.setTextureRect(IntRect(42 * int(CurrentFrame), 42, 42, -42)); //проходимся по координатам Х. получается 96,96*2,96*3 и опять 96
			}
		}
